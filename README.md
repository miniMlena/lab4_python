Интересные сиды:
16 - на шаге 3 добавляется такая же книга, какая уже была в библиотеке и можно увидеть, что она все равно отобразилась в библиотеке и исбн одинаковые (но шаги 8-12 там кажутся странными, легко запутаться)
177 - на шаге 13 и 18 чел получил свою книгу (по комбо) и видно, что в итоговой библиотеке их нет
44 - на шаге 14 чел получил книгу по исбн (Питонидзе Л.Р. - "Сэнсей и Мао Ито", 1982, роман, ISBN: 978-2-46000-757-0), на шаге 18 - по комбо и в конце видно, что их больше нет в библиотеке (у питонидзе есть очень похожая, но не прям такая)
33 - на шаге 16 чел пытается получить по комбо, но есть 2 подходящих книги и недостаточно сведений. В конце видно, что обе книги остались в коллекции
